...
function patch(path,a,b){let s=fs.readFileSync(path,'utf8');if(s.includes(b))return;if(!s.includes(a))throw Error('missing v0.57 patch anchor in '+path+': '+a);fs.writeFileSync(path,s.replace(a,b))}
