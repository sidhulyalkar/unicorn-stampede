...
let r='src/render.js',z=fs.readFileSync(r,'utf8'),dead="X.strokeStyle='rgba(255,255,255,.12)';X.lineWidth=5;X.setLineDash([30,30]);X.beginPath();X.moveTo(WW/2,0);X.lineTo(WW/2,WH);X.stroke();X.setLineDash([])";
if(!z.includes(dead))throw Error('district divider marker moved');z=z.replace(dead,'');fs.writeFileSync(r,z);
