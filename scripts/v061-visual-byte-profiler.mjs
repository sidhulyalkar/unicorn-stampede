...
const plans={base:[],hueFormula:['hueFormula'],noBench:['bench'],noFence:['fence'],noBush:['bush'],noMicro:['micro'],noProps:['props'],noGem:['gem'],noAttic:['attic'],noStreet:['street'],noAwning:['awning'],lite:['hueFormula','bench','fence','micro','props','gem'],liteGarden:['hueFormula','bench','micro','props','gem'],coreGrammar:['hueFormula','street','fence','bush','micro','props','gem','attic']};
