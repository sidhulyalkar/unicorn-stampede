...
for(const m of ["['#796','#cb9','#789'][zone]","text(done?'✓':l.n[0]","u.ai=.2,u.tx=u.x+u.vx,u.ty=u.y+u.vy","e.preventDefault();e.stopImmediatePropagation();if(e.button+e.detail>1)return;"])if(!s.includes(m))throw Error('release identity/safety marker missing: '+m);
