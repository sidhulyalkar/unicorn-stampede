...
p='scripts/smoke.mjs';s=fs.readFileSync(p,'utf8');if(!s.includes("!rs.includes('n=k+3')"))throw Error('legacy facade assertion missing');s=s.replace("!rs.includes('n=k+3')",`!rs.includes("['()','$','[]','~','*']")`);fs.writeFileSync(p,s);
