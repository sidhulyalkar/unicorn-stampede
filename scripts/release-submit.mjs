...
export function submissionSource(raw){let s=releaseSource(raw);for(let a of cuts)s=remove(s,a);return fuseRelease(compactTownGrammar(compactRepresentation(staticizeWrappers(s))))}
