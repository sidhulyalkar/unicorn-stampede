import{releaseSource}from'./release-prune.mjs';import{staticizeWrappers}from'./release-staticize.mjs';
...
export function submissionSource(raw){let s=releaseSource(raw);for(let a of cuts)s=remove(s,a);return staticizeWrappers(s)}
