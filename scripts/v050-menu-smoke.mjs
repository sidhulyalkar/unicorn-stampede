...
need(exp,"text('START'",'start menu label missing');need(exp,"text('TUTORIAL '+",'tutorial toggle label missing');need(exp,"text('< '+ZN[zone]+' >'",'world label missing');need(exp,"state='title';objs=[]",'tutorial completion does not return to menu');ban(exp,'ENTER • TRAINING','legacy forced-training label remains');ban(exp,'SKIP TO MENU','legacy training skip remains');
