...
need(exp,"text('START'",'start menu label missing');need(exp,"text('TUTORIAL '+",'tutorial toggle label missing');need(exp,"text('< '+N[21+zone]+' >'",'world label missing');need(whip,"intro.step===10&&e.code==='Enter'",'tutorial debrief does not return to menu on Enter');need(whip,"state='title';objs=[]",'tutorial debrief exit does not cleanly return to menu');ban(exp,'ENTER • TRAINING','legacy forced-training label remains');ban(exp,'SKIP TO MENU','legacy training skip remains');
