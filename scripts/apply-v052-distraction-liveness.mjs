...
edit('src/herd.js',"else{u.x-=u.vx*dt;u.y-=u.vy*dt;u.vx=u.vy=u.ai=0;if(o.t==='fountain'||o.t==='pond')", "else{let x=u.x-o.x-o.w/2,y=u.y-o.y-o.h/2;if(Math.abs(x/o.w)>Math.abs(y/o.h))u.x=o.x+(x>0?o.w+ex:-ex);else u.y=o.y+(y>0?o.h+ex:-ex);u.vx=u.vy=u.ai=0;if(o.t==='fountain'||o.t==='pond')");
...
console.log('staged spawn/scenery clearance + finite distractions + aligned aggression + collision projection');
