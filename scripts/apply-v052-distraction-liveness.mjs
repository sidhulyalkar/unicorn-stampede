...
edit('src/herd.js',"else{u.x-=u.vx*dt;u.y-=u.vy*dt;u.vx=u.vy=u.ai=0;if(o.t==='fountain'||o.t==='pond')", "else{let x=u.x-o.x-o.w/2,y=u.y-o.y-o.h/2;if(Math.abs(x/o.w)>Math.abs(y/o.h))u.x=o.x+(x>0?o.w+ex:-ex),u.vx=0,u.tx=u.x,u.ty=o.y+(u.y<o.y+o.h/2?-ex:o.h+ex);else u.y=o.y+(y>0?o.h+ex:-ex),u.vy=0,u.ty=u.y,u.tx=o.x+(u.x<o.x+o.w/2?-ex:o.w+ex);u.ai=2;if(u.cool<5&&(o.t==='fountain'||o.t==='pond'))");
...
console.log('staged spawn/scenery clearance + finite distraction + aligned aggression + geometry-aware wall navigation');
