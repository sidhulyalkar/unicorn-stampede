...
edit('src/herd.js',"else{u.x-=u.vx*dt;u.y-=u.vy*dt;u.vx=u.vy=u.ai=0;if(o.t==='fountain'||o.t==='pond')", "else{let x=u.x-o.x-o.w/2,y=u.y-o.y-o.h/2;if(Math.abs(x/o.w)>Math.abs(y/o.h)){u.x=o.x+(x>0?o.w+ex:-ex);u.vx=0;if(!u.cap)u.vy+=(o.y<40?1:o.y+o.h>WH-40?-1:u.y<o.y+o.h/2?-1:1)*80}else{u.y=o.y+(y>0?o.h+ex:-ex);u.vy=0;if(!u.cap)u.vx+=(o.x<40?1:o.x+o.w>WW-40?-1:u.x<o.x+o.w/2?-1:1)*80}u.ai=0;if(u.cool<5&&(o.t==='fountain'||o.t==='pond'))");
...
console.log('staged spawn/scenery clearance + finite distraction + aligned aggression + boundary-aware AI wall glide');
