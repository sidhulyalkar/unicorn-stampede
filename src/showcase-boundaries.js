...
let showcaseBoundaryCorrections=0,showcaseSolidCorrections=0,showcaseInvalidRecoveries=0;
...
function showcaseSolidCandidate(u){
  const a=showcaseObjectGrid.get(showcaseGridKey(Math.floor(u.x/SHOWCASE_GRID),Math.floor(u.y/SHOWCASE_GRID)))||[];
  const ex=u.cap?32:20;
  for(const o of a)if(o.hp>0&&u.x>o.x-ex&&u.x<o.x+o.w+ex&&u.y>o.y-ex&&u.y<o.y+o.h+ex)return{o,ex};
  return null;
}
