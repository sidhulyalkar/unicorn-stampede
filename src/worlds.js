...
function harbor(){let f=q=>{q.x=cl(q.x+(q.x<300?260:q.x<1600?-120:160),20,WW-(q.w||20));q.y=cl(q.y+(q.t==='stall'||q.y<900?-80:100),20,WH-(q.h||20))};for(let a of [objs,ups,flowers,unis,people,flies,cars])for(let q of a)f(q);objs=objs.filter(o=>o.t!=='hedge');roads=[[640,0,180,WH],[1420,0,180,WH],[2480,0,180,WH],[0,460,WW,190],[0,1230,WW,190],[1580,960,1620,90]]}
