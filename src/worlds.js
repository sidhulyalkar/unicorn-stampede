...
const _townDraw=drawObjs;drawObjs=function(){if(level)for(let o of objs)if(o.t==='b'){let q=(o.x>1600)+2*(o.y>900);X.fillStyle=`hsl(${48+q*31} 12% 80%)`;X.fillRect(o.x-7,o.y-7,o.w+14,o.h+14);X.fillStyle='#0003';X.fillRect(o.x+7,o.y+7,o.w,o.h)}_townDraw();if(level){X.fillStyle='#3e4651';for(let o of objs)if(o.t==='b'){let g=o.x+o.y|0;if(o.hp)X.fillRect(o.x+12+g%37,o.y+9,18+(g&15),5+(g>>3&7));for(let i=g&3;i--;)X.fillRect(o.x+8+i*13,o.y+o.h+2,8,2)}}};
const _titleW=title;
