...
const _townDraw=drawObjs;drawObjs=function(){if(level)for(let o of objs)if(o.t==='b'){let g=o.x+o.y|0,p=4+(g&3);X.fillStyle='#d8d8d0';X.fillRect(o.x-p,o.y-p,o.w+p*2,o.h+p*2);X.fillStyle='#0003';X.fillRect(o.x+7,o.y+7,o.w,o.h);X.fillStyle='#3e4651';for(let i=p-4;i--;)X.fillRect(o.x+8+i*13,o.y+o.h+1,8,2)}_townDraw();if(level){X.fillStyle='#3e4651';for(let o of objs)if(o.t==='b'&&o.hp){let g=o.x+o.y|0;X.fillRect(o.x+12+g%37,o.y+9,18+(g&15)+(o.x>1600)*5,5+(g>>3&7)+(o.y>900)*4)}}};
const _titleW=title;
