...
showcaseMenu.innerHTML=`<div class="showcase-menu-card">
  ...
  <div class="showcase-menu-head"><div><h1>UNICORN STAMPEDE</h1><p>Manage six semi-autonomous unicorns. Break the town. Keep the herd alive.</p></div><div class="showcase-menu-badge">4 WORLDS<br><span>ONE HERD</span></div></div>
...
function showcaseRefreshMenu(){
  const visible=state==='title'&&!guide;showcaseMenu.classList.toggle('showcase-menu-hidden',!visible);showcaseMenu.setAttribute('aria-hidden',String(!visible));
...
globalThis.showcaseMenuAPI={refresh:showcaseRefreshMenu,setWorld:showcaseSetWorld,setMode:showcaseSetMode,start:showcaseStart,get visible(){return !showcaseMenu.classList.contains('showcase-menu-hidden')}};
