...
function showcaseFreshStats(){return{time:0,switches:0,whips:0,dashes:0,powerups:0,buildings:0,damage:0,maxCharge:0}}
...
cycle=function(){const before=caps[0];const r=showcaseStatsCycleBase();if(state==='play'&&caps[0]!==before)showcaseRunStats.switches++;return r};
...
hitObj=function(u,o,d){const before=o?.hp||0;const r=showcaseStatsHitBase(u,o,d);if(o&&before>o.hp){showcaseRunStats.damage+=before-o.hp;if(before>0&&o.hp<=0)showcaseRunStats.buildings++}return r};
...
const showcaseStatsEndBase=end;
  ...
  X.fillStyle='#07101dcc';rr(W/2-330,350,660,145,18);
